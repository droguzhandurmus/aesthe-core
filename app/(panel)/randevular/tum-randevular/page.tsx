...
function MultiSelectIslemCombobox({
  ...
  type = "Klinik", // "Klinik" veya "Ameliyat"
}: {
  options: string[];
  ...
  function handleAddNewClick() {
    // Arama kutusunda bir şey varsa ve listede yoksa
      ...
      <Modal open={open} onClose={onClose} title="Yeni Randevu Oluştur" wide>
        <form className="p-6 flex flex-col gap-4" onSubmit={onSave} autoComplete="off">
          ...
          <div>
              ...
              <button
                ...
                onClick={() =>
                  setForm((prev: any) => ({
                    ...
                    secilen_islemler: prev.tur === "Klinik" ? [] : [],
                  }))
                }
                disabled={saving}
                tabIndex={0}
              ...
              <button
                ...
                onClick={() =>
                  setForm((prev: any) => ({
                    ...
                    secilen_islemler: prev.tur === "Ameliyat" ? [] : [],
                  }))
                }
                disabled={saving}
                tabIndex={0}
            ...
            {/* Multi-Select Combobox (sadece seçim olursa açılır) */}
            {form.tur === "Klinik" && (
        ...
        {!editMode ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              {/* NOT: Detay/düzenle modaldaki islem listelerini hala sabit constant ile bıraktık, ana ihtiyaç ilk Randevu Ekle modalı için idi */}
              {form.tur === "Klinik" && (
                <MultiSelectIslemCombobox
...
export default function TumRandevularPage() {
  ...
  // --- Dinamik İşlem Listeleri (page-level) ---
