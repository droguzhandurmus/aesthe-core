...
function isKlinikCategory(islemTuru: string | undefined): boolean {
  if (!islemTuru || islemTuru === "Belirtilmedi") return true;
  return islemTuru !== "Ameliyat" && !islemTuru.startsWith("Ameliyat: ");
}
...
export default function KlinikListesiPage() {
  ...
  const randevular = useMemo(
    () => tumRandevular.filter((r) => isKlinikCategory(r.islem_turu)),
    [tumRandevular]
  );
  ...
  return (
    <div className="px-4 md:px-8 py-6">
      <div className="flex items-center justify-between mb-5">
        <h1 className="text-2xl font-bold text-blue-800 tracking-tight">Klinik Listesi</h1>
